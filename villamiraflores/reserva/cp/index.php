  ...
  <form action="authenticate.php" method="post" id="formlogin">
   <table border="0" cellpadding="5" cellspacing="0">
    ...
    <tr>
     ...
     <tr><td style="padding-right:10px;"> <img src="captcha_code_file.php?rand=<?php echo rand(); ?>" id='captchaimg' ></td><td>
Enter the code left here :<br>
<input id="6_letters_code" name="6_letters_code" type="text" class="login-inp"><br>
<small>Can't read the image? click <a href='javascript: refreshCaptcha();' style="color:#FFF">here</a> to refresh</small></td>
</tr>
