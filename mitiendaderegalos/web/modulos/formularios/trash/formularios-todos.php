...
$body_firma.="<a href='".$vars['REMOTE']['httpfiles']."'>".$vars['REMOTE']['httpfiles']."</a>";
		...
		if(
			(in_array($_GET['modulo'],array("formulario")) and $_GET['tab']=='login' ) or //front	completo	
			(in_array($_GET['modulo'],array("app"))  ) or //front bloque
		...
		if(
			($_GET['mode']=='form' and $_GET['tab']=='cerrar_sesion' )  										// ajax back			
		){
		...
		/**********************************************/
		if(
			(in_array($_GET['modulo'],array("formulario")) and $_GET['tab']=='registro' ) or				// front completo
			($_GET['mode']=='form' and $_GET['tab']=='registro' )  												// ajax back			
		){
		...
		/**********************************************/
		if(
			(in_array($_GET['modulo'],array("formulario")) and $_GET['tab']=='publicar-anuncio-1' ) or	// front completo
			($_GET['mode']=='form' and $_GET['tab']=='publicar-anuncio-1' )  									// ajax back			
		){
		...
		/**********************************************/
		if(
			(in_array($_GET['modulo'],array("formulario")) and $_GET['tab']=='publicar-anuncio-2' ) or	//front completo
			($_GET['mode']=='form' and $_GET['tab']=='publicar-anuncio-2' )  									//ajax back			
		){
		...
		/**********************************************/
		if(
			(in_array($_GET['modulo'],array("formulario")) and $_GET['tab']=='contacto' ) or 	//front	completo	
			(in_array($_GET['modulo'],array(
												"static"
												,"items"
												,"item"))) or 									//front bloque
			($_GET['mode']=='form' and $_GET['tab']=='contacto' )  										//ajax back			
		){
		...
		if(
			...
			($_GET['mode']=='form' and $_GET['tab']=='recomendar' )  		//ajax back
		){
		...
		/**********************************************/
		if(
			(in_array($_GET['modulo'],array("formulario")) and $_GET['tab']=='carrito') or //front completo
			($_GET['mode']=='form' and $_GET['tab']=='carrito' )  								  //ajax back			
		){
