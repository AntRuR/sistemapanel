				...
				foreach($lineas as $linea){
					...
					foreach($campS as $camP){
						...
						switch($objeto_tabla[$obj['obj']]['campos'][$camP]['tipo']){
							...
							case "html":
							// prin($linea);
							echo ($linea[$camP]!='')?((strlen($linea[$camP])>1000 and 1)?'<a class="mb" rel="width:1050,height:530" href="field.php?get='.$objeto_tabla[$obj['obj']]['tabla'].','.$camP.','.$linea['id'].'">mostrar texto</a>':"<div class='htmlenlista'>".stripslashes($linea[$camP])."</div>"):"&nbsp;";
							/*break;
