...
<li class="listado_item">
    ...
    <!--foto-->
    <a class="foto mb" rel="[images],noDesc" href="<?php echo $item['get_archivo']; ?>"><img title="<?php echo $item['nombre'];?>" <?php echo $item['get_atributos']; ?> alt="<?php echo $item['nombre'];?>" /></a>
    <!--nombre-->
