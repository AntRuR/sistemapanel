...
?>
<style>
body { background:none; text-align:left;background-color:#FFF !important; }
...
.formulario { padding-top:0; padding-bottom:7px !important;  }
.formulario label { padding-top:0 !important; }
.mooeditable-ui-button-overlay .overlay-content a { font-size:10px; padding-top:0px;padding-bottom:0px; }
.mooeditable-ui-button-overlay { width:655px !important; }
</style>
<body>
<?php
