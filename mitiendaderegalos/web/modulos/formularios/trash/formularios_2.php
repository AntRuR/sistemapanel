...
$body_firma.="<a href='".$vars['REMOTE']['httpfiles']."'>".$vars['REMOTE']['httpfiles']."</a>";
		...
		if(
			...
			(in_array($_GET['modulo'],array("items")) ) or //front bloque
		...
		/**********************************************/
		if(
			(in_array($_GET['modulo'],array("formulario")) and $_GET['tab']=='registro' ) or
		...
		/**********************************************/
		if(
			(in_array($_GET['modulo'],array("formulario")) and $_GET['tab']=='publicar-anuncio-1' ) or
		...
		/**********************************************/
		if(
			(in_array($_GET['modulo'],array("formulario")) and $_GET['tab']=='publicar-anuncio-2' ) or
		...
		/**********************************************/
		if(
			(in_array($_GET['modulo'],array("home","pagina","items","item","formulario","app"))) or //front bloque
