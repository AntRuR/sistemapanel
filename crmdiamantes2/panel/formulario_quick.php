...
echo '<style>
		...
		/*body {background:url(http://g-ecx.images-amazon.com/images/G/01/digital/video/avod-1-5/black-grad._V198353446_.png) !important;}*/
		.contenido_principal{border-radius:0;} .formulario {border:0;} .formulario label {padding-top:0px;padding-bottom:0px;padding-left:5px;} .formulario .form_input {margin-top:0px;margin-bottom:0px;}.boton_right{display:none;}
		.titulo_formulario { margin: 0 0 10px 0; padding: 5px; text-transform:uppercase; background: #000000; color: #FFFFFF; font-size: 18px; font-weight: bold; }
		/*.formulario label { color:#C5C5C5; }
		#error_creacion span { color:#FFF !important; }*/
		</style>';
