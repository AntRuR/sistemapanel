...
$objeto_tabla['VENTAS_ITEMS']=array(
		...
		'app'			=> '
		<a href="app.php?ap=reporte_vendedores" class="submenu">Reporte Vendedores</a>
		<a href="app.php?ap=reporte_jefe" class="submenu">Reporte Jefe de Ventas</a>
		',
		...
		'postscript'	=> '
				...
				if(SS=="insert"){
					...
					update(array("id_jefe"=>$jefe,"id_usuario"=>LL["id_usuario"]),"clientes","where id=".LL["id_cliente"],0);
