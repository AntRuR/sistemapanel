 ...
 ?>    
      ...
      <hr />
        <table class="display datatable" border="0">
          <thead>
	<tr><th width="18%" nowrap="nowrap"><?php echo CUSTOMERLOOKUP_GUEST_NAME;?></th><th width="25%" nowrap="nowrap"><?php echo CUSTOMER_STREET_ADDRESS;?></th><th width="15%" nowrap="nowrap"><?php echo CUSTOMERLOOKUP_PHONE_NUMBER;?></th><th width="32%" nowrap="nowrap"><?php echo CUSTOMERLOOKUP_EMAIL_ID;?></th></tr>
 </thead>
