...
<div>
	...
	*/
	...
	if($_SESSION['usuario_datos_id']){
		...
		$mmmM.=  "<strong>". $_SESSION['usuario_datos_nombre'] ."</strong>";
	}
	//$mmmM.= "</a>";
...
if(sizeof($FiLa)){
	...
	$menus_d['grupo']=  ($_SESSION['usuario_datos_nombre_grupo'])?"<li class='m_grupo'><strong>". $_SESSION['usuario_datos_nombre_grupo'] ."</strong></li>":'';
...
echo "<div style='clear:left;position:relative;padding:0 3px;'>";
...
if(!($_COOKIE['ap']!='' or $_COOKIE['admin']=='1' or in_array($SERVER['ARCHIVO'],$validos) or in_array($SERVER['ARCHIVO'],array('maquina.php','login.php')))){
