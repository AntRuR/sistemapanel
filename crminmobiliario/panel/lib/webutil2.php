...
function web_render_foot($OBJECT,$SERVER){
 ...
 * ANALYTICS
 */
if($INCLUDE['analytics_code'] and !$SERVER['LOCAL']){
$html.="<script>
...
ga('create','".$INCLUDE['analytics_code']."');ga('send','pageview');
</script>";
}
...
function web_render_head($HEAD,$SERVER){
