<?php //á
	...
	//		,'tipo'=>'textarea'
			...
			,'value_email'=>array(select_dato('nombre','usuarios','where id="'.$_SESSION['login']['id'].'"')." ".select_dato('apellidos_paterno','usuarios','where id="'.$_SESSION['login']['id'].'"'))
		)
...
,'campos'=>$CAMPOS
	...
	////////////body_cliente
				...
				$Email=($_SESSION['login']['status'])?$_SESSION['login']['email']:$_POST['email'];
