...
<form id="buscador_form" method="get" action="index.php">
    ...
    <option value="<?php echo $departamento['id'];?>"><?php echo ucfirst($departamento['nombre']);?></option>
	<?php } ?>	
    </select>
    </div>
        
    <div id="div_buscador_provincia">
    <select id="buscador_provincia" name="provincia" onchange="get_distritos(this.value);" >
    <option value="">Provincia</option>
    <?php foreach($BUSCADOR['provincias'] as $provincia){ ?>
    <option value="<?php echo $provincia['id'];?>"><?php echo ucfirst($provincia['nombre']);?></option>
	<?php } ?>
    </select>
    </div>
    ...
    <option value="<?php echo $distrito['id'];?>"><?php echo ucfirst($distrito['nombre']);?></option>
	<?php } ?>
    </select>
    </div>
	...
	$('buscador_tipo').value='<?php echo $_GET['tipo']; ?>';
	$('buscador_departamento').value='<?php echo $_GET['departamento']; ?>';
	$('buscador_provincia').value='<?php echo $_GET['provincia']; ?>';
	$('buscador_distrito').value='<?php echo $_GET['distrito']; ?>';	
