...
$query0="select img_pro5 from producto where id_pro='$id_pro'";
$rs_query0 = mysql_query($query0, $cn) or die(mysql_error());
$row_rs_query0 = mysql_fetch_assoc($rs_query0);
$nombre_img = substr($row_rs_query0['img_pro5'], 0, strlen($row_rs_query0['img_pro5'])-4);
$img_pro = $nombre_img.".jpg";
	...
	$query1="update producto set  img_pro5='$img_pro' where id_pro='$id_pro'";
