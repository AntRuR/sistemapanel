...
$nombre_img = substr($row_rs_query0['img_pro1'], 0, strlen($row_rs_query0['img_pro1'])-4);
$img_pro = $nombre_img.".jpg";
	...
	//echo "nombre imagen:".$img_pro;
	$query1="update producto set  img_pro1='$img_pro' where id_pro='$id_pro'";
