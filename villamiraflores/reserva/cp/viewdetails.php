...
<div id="container-inside"> <span style="font-size:16px; font-weight:bold"><?php echo VIEW_BOOKING_DETAILS;?> :
  ...
  <table style="font-family:Verdana, Geneva, sans-serif; font-size: 12px; background:#999999; width:700px; border:none;" cellpadding="4" cellspacing="1">
    ...
    <tr>
     ...
     <tr>
      <td align="left" style="background:#ffffff;"><?php echo ID_TYPE;?></td>
      <td align="left" style="background:#ffffff;"><?=$rowviewdetails['id_type']?></td>
    </tr>
     <tr>
      <td align="left" style="background:#ffffff;"><?php echo ID_NUMBER;?></td>
      <td align="left" style="background:#ffffff;"><?=$rowviewdetails['id_number']?></td>
    </tr>
    
      <tr>
      <td align="left" style="background:#ffffff;">Additional Requests</td>
      <td align="left" style="background:#ffffff;"><?=($rowviewdetails['special_requests']=="")? 'NA':$rowviewdetails['special_requests']?></td>
    </tr>
