...
<form name="lincence" action="install.step1.php" method="post" onsubmit="return licenceAggrement();">
  ...
  <table align="center" width="60%" cellspacing="0" cellpadding="0" border="0"  class="table1">
      ...
      <td align="left" class="table_bg" colspan="2">ONLINE  HOTEL BOOKING SYSTEM Pro</td>
    ...
    <tr><td  class="table_content" align="justify" colspan="2"> All copyrights to Online Hotel Booking System Pro are exclusively owned by the authors: Best Soft Inc (http://www.bestsoftinc.com) </td>
    ...
    <tr>
      ...
      <td class="table_content" align="center" colspan="2"> Thank you for using Online  Hotel Booking System Pro.<br />
