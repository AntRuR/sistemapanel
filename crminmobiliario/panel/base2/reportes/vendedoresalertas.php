...
foreach($statuses as $usu){
	...
	if($usu['id']=='8'){
		...
		$STATU['8.5']="Separado+ Vendido+ Cancelado";
		$statuQueries['8.5']="and ventas_items.id_status in (6,7,8)";
...
// prin($atenciones);
	...
	$ALERS0=[
		1=>'pendientes (y para hoy)',
		2=>'atrasados (y atrasado pendiente de desistimiento)',
		3=>'desistido',
		4=>'cumplidos',
	];
	...
	$ALERS=[
		...
		1=>'and ventas_mensajes.estado in (1,2)',
		2=>'and ventas_mensajes.estado in (3,5)',
		3=>'and ventas_mensajes.estado in (6)',
		4=>'and ventas_mensajes.estado in (4)',
	...
	$aaab=select(
				...
				"left join ventas_items on ventas_items.id=ventas_mensajes.id_grupo
				 where 
				 date(ventas_mensajes.alerta_fecha) between '".$from."' and '".$to."'
				 ".str_replace('ventas_items.id_usuario','ventas_mensajes.id_usuario',$context)."
