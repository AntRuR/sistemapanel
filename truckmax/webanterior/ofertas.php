...
$row_rs_query2 = mysql_fetch_assoc($rs_query2);
	...
	if(isset($_GET['empezar'])){
		$query4 = "SELECT * FROM `producto` WHERE `pre_ofer` >= '1' ORDER BY `producto`.`id_pro` DESC limit ".$empezar.",6";
	}else{
		$query4 = "SELECT * FROM `producto` WHERE `pre_ofer` >= '1' ORDER BY `producto`.`id_pro` DESC limit 0,6";
	}
                ...
                <table width="728" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <table width="700" border="0" cellpadding="0" cellspacing="0" style="width:100%">
                      <tr>
                        <td height="28" class="ruta">OFERTAS DEL MES</td>
                        </tr>
                      <tr>
                        <td height="28">
                              ...
                              <? //consulta para identificar el comentario de subcategoria
							   ...
							   ?>
                                <td class="texto"><p>
                                  ...
                                  Le invitamos a revisar nuestras ofertas mensuales y visitar continuamente nuestra web <a href="http://www.truckmax.com.pe">www.truckmax.com.pe</a> para revisar las nuevas oportunidades de precio</p>
                                  <p>* la validez de la oferta es solo hasta agotar el stock </p></td>
                              </tr>
                            </table>
                            </td>
                            <td width="1" valign="top" background="images/div_sub.jpg"></td>
