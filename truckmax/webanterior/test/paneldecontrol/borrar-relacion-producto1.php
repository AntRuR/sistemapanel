...
function mostrarSubcate(valor,id){
	if(id=="1"){
		ObtenerDatos('borrar-relacion-producto2.php?categoria='+valor+'&id='+id+'&fecha='+Date(),'subcate1');
	}
	if(id=="2"){
		ObtenerDatos('borrar-relacion-producto2.php?categoria='+valor+'&id='+id+'&fecha='+Date(),'subcate2');
	}
}
function mostrarProducto(valor,id){
	if(id=="1"){
		ObtenerDatos('borrar-relacion-producto3.php?subcate='+valor+'&id='+id+'&fecha='+Date(),'prod1');
	}
	if(id=="2"){
		ObtenerDatos('borrar-relacion-producto3.php?subcate='+valor+'&id='+id+'&fecha='+Date(),'prod2');
	}
}
function Validar(){
...
function mostrarProductoRela(valor){
	ObtenerDatos('borrar-relacion-producto4.php?id_pro='+valor+'&fecha='+Date(),'prod1_1');
}
</script>
</head>
<body>
