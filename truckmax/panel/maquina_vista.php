...
foreach($objeto_tabla as $ot){
			...
			echo '<td >' . ( ($archivos_creados)?"<span class='creado'><img src='img/ico_yes.gif'/></span> <a href='".$SERVER['BASE'].$SERVER['ARCHIVO']."?me=".$ot['me']."&accion=borrararchivos&maquina=1'>del</a>&nbsp;<a href='".$SERVER['BASE'].$SERVER['ARCHIVO']."?me=".$ot['me']."&accion=recreararchivos&maquina=1'>redo</a>":"<span class='nocreado'><img src='img/ico_no.gif'/></span> <a href='".$SERVER['BASE'].$SERVER['ARCHIVO']."?me=".$ot['me']."&accion=creararchivos&maquina=1' >create</a>"). '</td>';

			echo '<td>';
			
			if($ot['bloqueado']=='1'){
				echo ( $tabla_creada )?'<span class="creado"><img src="img/ico_yes.gif"/></span> bloqueado':'<span class="nocreado"> -- </span> <a href="'.$SERVER['BASE'].$SERVER['ARCHIVO'].'?me='.$ot['me'].'&accion=creartabla&maquina=1" >create</a>';
			} else {
			...
			if($ot['bloqueado']=='1'){
				...
				if ( !$tabla_creada and !$archivos_creados ){ 
					echo '<a href="'.$SERVER['BASE'].$SERVER['ARCHIVO'].'?me='.$ot['me'].'&accion=creararchivostabla&maquina=1" >create</a>';
				}	
			}			
		...
		if($_GET['me']==''){
			...
			foreach($tabla3 as $ta){
			  ...
			  echo "</td>";
			  echo (in_array($ta,$tablas_multiopciones))?"<td style='text-align:left;' class='small'><b><a style='color:red;'>".strtoupper($ta)."</a></b></td>":"<td style='text-align:left;'>".$ta."</td>";
			  echo "<td></td>";
			  echo "<td></td>";
			  echo "<td><span class='creado'>creado</span> <a href='".$SERVER['BASE'].$SERVER['ARCHIVO']."?tabla=".$ta."&accion=borrartabla2&maquina=1'>borrar</a></td>";
			  echo "<td></td>";
			  echo "</tr>";
			}
			...
			foreach($archivos6 as $ar){
			  ...
			  echo "<td></td>";
			  echo "<td><span class='creado'>creado</span> <a href='".$SERVER['BASE'].$SERVER['ARCHIVO']."?archivo=".$ar."&accion=borrararchivos2&maquina=1'>borrar</a></td>";
			  echo "<td></td>";
			  echo "<td></td>";
			  echo "</tr>";
			}	
...
<?php
	...
	echo '<h4>Análisis de archivos</h4>';
...
//	print_rr($tiempos);
	...
	echo "<a href='#' onclick=\"selec('_panelbase2');return false;\" rel='nofollow'>BASE 2</a>";
