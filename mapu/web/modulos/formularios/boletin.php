...
include_once("formularios/formularios.php");
			...
			$FORM=$FORMULARIO[$PARAMS['conector']]=array(
					...
					,'titulo'=>'Boletín'
					,'legend'=>"Suscríbete gratis al boletín"
					,'ajax'=>'1'
					...
					,'exito'=>'Gracias por inscribirse en nuestro boletín.'
...
/*CAMPOS-END*/
	...
	////////////body_administrador			
				$body_administrador ="";
				$body_administrador.="Desde la web, se han suscrito al boletin con los siguientes datos:<br><br>";
				...
				$email_administrador=enviar_email(
								...
								,'Subject'=>'Suscripción a Boletin desde '.$PARAMETROS_EMAIL['nombre_web']
	...
	////////////body_cliente
				...
				$body_cliente.="Te has suscrito al boletín ".$PARAMETROS_EMAIL['nombre_web']." con los siguienes datos:<br><br><br>";
				...
				$email_cliente=enviar_email(
								...
								,'Subject'=>"Suscripción al boletín de ".$PARAMETROS_EMAIL['nombre_web']
								,'body'=>$body_cliente
								//,'From'=>'info@afarmach.com'
								//,'FromName'=>'Afarmach'							
								//,'Logo'=>''
