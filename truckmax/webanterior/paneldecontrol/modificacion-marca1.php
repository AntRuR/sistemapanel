...
function validar(valor){
	...
	if(document.frm1.marcades.value==""){
		alert("Debe Escribir un nuevo Nombre para la Marca");
		return false;
	}
...
<table>
  <tr>
    <td align="center" class="textos">Marcas Registradas: </td>
    <td class="textos"><?php
    ...
    <tr>
      <td class="textos">Nuevo Nombre de la Marca: </td>
      <td><input name="marcades" type="text" class="textos" /></td>
    </tr>
    <tr>
