...
$objeto_tabla['PRODUCTOS_ITEMS_ITEMS']=array(
		...
		'campos'		=>array(
				...
				'id_items_tipo'	=>array(
						...
						'tags'			=> '1',
						'queries'		=> '1',
						'load'			=> '|||pvlista,pvpromocion,area_total,area_construida,descripcion,num_rooms,num_bathrooms|productos_tipos|where id=[id_items_tipo];|html|descripcion2,descripcion3,descripcion4|productos_tipos|where id=[id_items_tipo];|checks|has_balcon|productos_tipos|where id=[id_items_tipo]'
				),
...
$objeto_tabla['VENTAS_ITEMS']=array(
		...
		'postscript'	=> '
				...
				if(SS=="updatemass"){
					...
					foreach(AA as $i){
						...
						update(["user"=>$usu_session,"id_usuario"=>$ll["id_usuario"],"info"=>$info],"clientes","where id=".$ll["id_cliente"],0);
		...
		'more'			=>array(
				'clientes'		=> 'distrito?listable=1&queries=1&after=id_cliente',
		...
		'campos'		=>array(
				...
				'id_cliente'	=>array(
						...
						'controles'		=> '<a href="pop.php?app=enviar_cotizacion&id=[id]" style="color:red;" >Mensaje</a>
							<a target="_black" href="../cotizacion/[id]">imprimir</a>
...
$objeto_tabla['CLIENTES']=array(
		...
		'campos'		=>array(
				...
				'tipo_cliente'	=>array(
						...
						'eventos'		=>array(
								'1'			=> '$1("id_in_genero");$1("id_in_apellidos");$0("group_persona_contacto");$1("group_pago");$1("group_conyuge");$H("la_nombre","Nombre");$H("la_apellidos","Apellidos");$H("la_direccion","Dirección");$H("la_genero","Género");',
								'2'			=> '$0("id_in_genero");$0("id_in_apellidos");$1("group_persona_contacto");$0("group_pago");$0("group_conyuge");$H("la_nombre","Razón Social");$H("la_direccion","Dirección");'
						),
						'derecha'		=> '1',
						'width'			=> '60px',
						'queries'		=> '1'
...
$objeto_tabla['PRODUCTOS_VENTAS_DOCUMENTOS']=array(
		...
		'script'		=> $objeto_tabla['PRODUCTOS_VENTAS']['script'],			
		'postscript'	=> '
				if(LL["moneda"]=="soles")
				{
					$ttcc=LL["tc"];
				...
				if(SS=="insert" or SS=="update")
				{
					...
					$item_item=fila("id_cliente,id_usuario,id_ventas_item","productos_ventas","where id=".LL["id_grupo"],0);
					$saldo=$pvfinal;
					$montoT=0;
					$recibidoT=0;
