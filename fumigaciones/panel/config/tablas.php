...
$objeto_tabla['PAGINAS_GROUPS']=array(
		...
		'campos'		=>array(
				...
				'name'		=>array(
						...
						'listable'		=> '1',
						'validacion'	=> '1',
						'controles'		=> '<a  rel="subs" href="custom/paginas.php?id=[id]">{select count(*) from paginas where id_grupo=[id]}  páginas</a>',
						'style'			=> 'width:70%;',
						// 'constante'		=> '1',
				),
				'page'			=>array(
...
$objeto_tabla['PAGINAS']=array(
		'titulo'		=> 'Páginas : {select name from paginas_groups where id=[id]}',
