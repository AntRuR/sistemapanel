...
//prin("index.php?modulo=items&tab=productos&acc=list&gru=".$ITEM['id_tipo']);

$OBJECT['header_menus']['menu'] = web_re_procesar_menu($OBJECT['header_menus']['menu'],procesar_url("index.php?modulo=items&tab=productos&acc=list&gru=".$ITEM['id_tipo']."&friendly=".$ITEM['tipo']));
