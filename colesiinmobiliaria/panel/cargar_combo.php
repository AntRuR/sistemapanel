...
?>
<select  id="<?php echo $datos_tabla['prefijo'];?>_in_<?php echo $tbcampA['campo'];?>" class="form_input" <?php echo ($tbcampA['style'])?'style="'.str_replace(",",";",$tbcampA['style']).'"':"";?>
<?php if($tbcampA['load']!=''){ 
...
<option selected="selected"></option>
    ...
    ?>
    <option value="<?php echo $oooo2['id']?>" ><?php echo fixEncoding($oooo2['nombre'])?></option>
    <?php
    }
    ?>
</select>
