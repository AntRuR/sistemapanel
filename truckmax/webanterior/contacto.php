...
function validar0(){
	...
	if(document.form1.empresa.value==""){
		...
		return document.frm1.empresa.focus();
	}
	if(document.form1.telf.value==""){
		alert("Debe Introducir su Numero teléfonico");
		return document.frm1.telf.focus();
	}
	if(document.form1.email.value==""){
		alert("Debe Introducir una direccion de correo electronico");
		return document.frm1.email.focus();
	}
	if(validarEmail(document.form1.email.value)){
	}else{
	   alert("La dirección de email es incorrecta");
	   return document.form1.email.focus();
	}
                        ...
                        <td><table width="700" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td valign="top"><table width="400" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
                                <td height="26" class="product"><strong>Email: <a href="mailto:ventas@truckmax.com.pe" class="product">ventas@truckmax.com.pe</a></strong></td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                <td height="26" class="product"><strong>Email: <a href="mailto:soporte@truckmax.com.pe" class="product">soporte@truckmax.com.pe</a></strong></td>
                              </tr>
                              <tr>
                            ...
                            <table border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td width="230" height="336" align="center" valign="top" background="images/bg_widget_bot.png">
                                ...
                                <table width="180" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <tr>
                                    <td align="left" class="texto"><strong>Nombre y Apellidos:</strong></td>
                                  </tr>
                                  <tr>
                                    <td align="left"><label>
                                      <input name="nom" type="text" class="texto" id="nom" />
                                    </label></td>
                                  </tr>
                                  <tr>
                                  ...
                                  <tr>
                                    <td align="left" class="texto"><strong>Nombre de Empresa:</strong></td>
                                  </tr>
                                  <tr>
                                    <td align="left"><input name="empresa" type="text" class="texto" id="empresa" /></td>
                                  </tr>
                                  <tr>
                                    <td height="4" align="left"></td>
                                  </tr>
                                  <tr>
                                    <td align="left" class="texto"><strong>Teléfono de Contacto:</strong></td>
                                  </tr>
                                  <tr>
                                    <td align="left"><input name="telf" type="text" class="texto" id="telf" /></td>
                                  </tr>
                                  <tr>
                                    <td height="4" align="left"></td>
                                  </tr>
                                  ...
                                  <tr>
                                    <td align="left"><input name="email" type="text" class="texto" id="email" /></td>
                                  </tr>
                                  <tr>
                                    <td height="4" align="left"></td>
                                  </tr>
                                  <tr>
                                    <td align="left" class="texto"><strong>Cometario:</strong></td>
                                  </tr>
                                  <tr>
                                    <td align="left"><label>
                                      <textarea name="coment" cols="24" rows="5" class="texto" id="coment"></textarea>
                                    </label></td>
                                  </tr>
                                  <tr>
                                    <td height="4" align="left"></td>
                                  ...
                                  <tr>
                                    <td align="left"><label>
                                      <input name="button" type="button" class="enviar" id="button" value="Enviar" onclick="validar0()"/>
                                    </label></td>
                                  </tr>
                                </table>
                                </form>
