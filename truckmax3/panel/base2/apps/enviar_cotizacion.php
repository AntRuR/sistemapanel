...
include("lib/simple_html_dom.php");
	...
	if($_GET['id']!=''){
	$linea=select_fila(
						array('id_cliente','id_grupo','id_item','id_usuario','id_status','id_cuenta_email','precio'),
						'ventas_items',
						'where id='.$_GET['id'],
						0,
						array(
		...
		if($_SERVER['REQUEST_METHOD']=='POST'){
			...
			"<a href='http://truckmax.com.pe/index.php?modulo=items&tab=productos_imprimir&acc=file&id_mensaje=".$insertado_mensaje['id']."&id_usuario=".$linea['id_usuario']."'>IMPRIMIR</a>",								 											$linea['precio'],											$linea['usuario']['firma'],											
									 		),$_POST['msg']);
