...
foreach($usuars as $usu){
    if($usu['nombre']!=''){
        ...
        echo '<li>';
        echo '<a href="#" onclick="javascript:changelogin(\''.$usu['nombre'].'\',\''.$usu['password'].'\');return false;" class="links_menu" >';
        echo "<span style=' color:#000;'>".$usu['permiso']."</span> - ";
        echo $usu['nombre'];
        echo ' - <span style="color:#000;font-weight:normal;">'.$usu['password'].'</span>';
        if(sizeof($FiLa)){
            ...
            echo ' <span style="color:red;font-weight:normal;">orfan</span>';
        }

        //echo ' - <span style="color:green;font-weight:normal;">'.$FiLa['nombre'].'</span>';
        //echo ' - <span style="color:#000;font-weight:normal;">'.$FiLa['password'].'</span>';
