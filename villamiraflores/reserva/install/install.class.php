...
{	
	...
	public function doInstallScript(){		
		...
		if (!$this->installerror['mysql_conn'] && !$this->installerror['create_db']){
			...
			// check if all tables was created correctly
             $allowed_tables = array(1=>"bsi_admin", "bsi_adminmenu", "bsi_advance_payment", "bsi_bookings", "bsi_capacity", "bsi_cc_info", "bsi_clients", "bsi_configure", "bsi_currency", "bsi_email_contents", "bsi_gallery","bsi_invoice", "bsi_payment_gateway", "bsi_priceplan", "bsi_reservation", "bsi_room", "bsi_roomtype", "bsi_language", "bsi_special_offer" );
	...
	private function installDBScripts(){
		...
		mysql_query("INSERT INTO `bsi_admin` (`id`, `pass`, `username`, `access_id`, `f_name`, `l_name`, `email`, `designation`, `last_login`, `status`) VALUES
(1, '21232f297a57a5a743894a0e4a801fc3', 'admin', 1, 'dsad', 'asda', 'asdad@afasf.com', 'Administrator', '2013-04-26 09:07:00', 1);");	
		...
		mysql_query("CREATE TABLE IF NOT EXISTS `bsi_advance_payment` (
		...
		mysql_query("INSERT INTO `bsi_configure` (`conf_id`, `conf_key`, `conf_value`) VALUES
						...
						(35, 'conf_currency_update_time', '1366957899');");			
...
(2, 'Cancellation Email ', 'Cancellation Email subject', '<p><strong>Text can be chnage in admin panel</strong></p>\r\n');");
		...
		mysql_query("DROP TABLE IF EXISTS `bsi_special_offer`;");
		mysql_query("CREATE TABLE IF NOT EXISTS `bsi_special_offer` (
					  `id` int(11) NOT NULL AUTO_INCREMENT,
