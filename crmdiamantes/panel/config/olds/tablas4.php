...
$objeto_tabla['VENTAS_ITEMS']=array(
		...
		'procesos'		=>array(
				array(
					...
					'file'		=> 'base2/apps/oc_status.php',
					// 'rel'		=> 'width:1400,height:980',
					'ran'		=> 'null',
					'rel'		=> 'width:300,height:550',
					// 'disabled'		=> '1'
				),	
				array(
					'label'		=> 'Desistimiento',
...
$objeto_tabla['VENTAS_ITEMS_ORDENES']=array(
	...
	'postscript'	=> '
			...
			if(SS=="update")
			{
				if(LL["orden_status"]=="1"){
					...
					update(["orden_status"=>"2"],"ventas_items","where id=".LL["id_grupo"],0);
	...
	'campos'		=>array(
			...
			'banco_explicacion_duplicidad'			=>array(
				...
				'label'			=> 'Explicación por dublicidad',
				'tipo'			=> 'txt',
				'listable'		=> '0',
				'validacion'	=> '0',
				'style'			=> 'width:150px;',
			...
			'orden_tipo_recibo'=>array(
					'campo'			=> 'orden_tipo_recibo',
			...
			'cliente_apellidos'			=>array(
				'campo'			=> 'cliente_apellidos',
				'label'			=> 'Apellidos',
				'tipo'			=> 'inp',
				'listable'		=> '0',
				'validacion'	=> '0',
			...
			'cliente_negocio'			=>array(
				'campo'			=> 'cliente_negocio',
			...
			'cliente_fecha_cliente'			=>array(
				'campo'			=> 'cliente_fecha_cliente',
				'label'			=> 'F.NAC/ANIV',
				'tipo'			=> 'fch',
				'width'			=> '110px',
				'listable'		=> '0',
			...
			'cliente_profesion'			=>array(
				'campo'			=> 'cliente_profesion',
				'label'			=> 'PROFESION',
				'tipo'			=> 'inp',
				'listable'		=> '0',
				'validacion'	=> '0',
			...
			'cliente_estado_civil'=>array(
				'campo'			=> 'cliente_estado_civil',
				'label'			=> 'ESTADO CIVIL',
				'tipo'			=> 'com',
				'listable'		=> '0',
				'validacion'	=> '0',
			...
			'cliente_conyuge'			=>array(
				'campo'			=> 'cliente_conyuge',
				'label'			=> 'CONYUGE',
				'tipo'			=> 'inp',
				'listable'		=> '0',
				'validacion'	=> '0',
			...
			'cliente_facturara'			=>array(
				'campo'			=> 'cliente_facturara',
				'label'			=> 'FACTURAR A',
				'tipo'			=> 'inp',
				'listable'		=> '0',
				'validacion'	=> '0',
...
$objeto_tabla['CLIENTES']=array(
		...
		'tipo_cliente'	=>array(
				...
				'eventos'		=>array(
						'1'			=> '$1("id_in_genero");$1("id_in_apellidos");$0("group_persona_contacto");$1("group_pago");$H("la_nombre","Nombre *");$H("la_apellidos","Apellidos *");$H("la_dni","DNI *");$H("la_direccion","Dirección *");$H("la_genero","Género *");',
						'2'			=> '$0("id_in_genero");$0("id_in_apellidos");$1("group_persona_contacto");$0("group_pago");$H("la_nombre","Razón Social *");$H("la_dni","RUC *");$H("la_direccion","Dirección *");'
				),
				'derecha'		=> '1',
				'width'			=> '70px',
				'queries'		=> '1'
