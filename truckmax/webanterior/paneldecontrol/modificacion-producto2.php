...
<input type="hidden" value="<?php echo $row_rs_query0['id_pro']?>" name="id_pro" />
                    <div id="accordion">
                    <h3><a href="#" class="textos">CARACTERISTICAS GENERALES</a></h3>
                    <div>
                    <table>
                      <tr>
                        <td colspan="2" align="center"><strong class="texts">INGRESO DE PRODUCTO</strong></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td><input  type="text"  value="<?php echo $row_rs_query0['pre_ofer']?>" name="oferta" size="80" /></td>
                      </tr>
                      <tr>
                                       ...
                                       <tr>
                                         ...
                                         <table width="300" border="0" cellspacing="0" cellpadding="0">
                                           <tr>
                                             ...
                                             <td class="textos"><input type="text" value="<?php echo $row_rs_query01['lar_tot']?>" name="lar_tot"/></td>
                                           </tr>
                                           <tr>
                                             <td width="140" height="26" class="textos">Alto Total (Mm.)</td>
                                             <td class="textos"><input type="text" value="<?php echo $row_rs_query01['alt_tot']?>" name="alt_tot"/></td>
                                           </tr>
                                           <tr>
                                             <td width="140" height="26" class="textos">Ancho Total (Mm.)</td>
                                             <td class="textos"><input type="text" value="<?php echo $row_rs_query01['anc_tot']?>" name="anc_tot"/></td>
                                           </tr>
                                           <tr>
                                             <td width="140" height="26" class="textos">Largo Carrozable</td>
                                             <td class="textos"><input type="text" value="<?php echo $row_rs_query01['lar_car']?>" name="lar_car"/></td>
                                           </tr>
                                           <tr>
                                             <td width="140" height="26" class="textos">Alto Carrozable</td>
                                             <td class="textos"><input type="text" value="<?php echo $row_rs_query01['alt_car']?>" name="alt_car"/></td>
                                           </tr>
                                           <tr>
                                             <td width="140" height="26" class="textos">Ancho Carrozable</td>
                                             <td class="textos"><input type="text" value="<?php echo $row_rs_query01['anc_car']?>" name="anc_car"/></td>
                                           </tr>
                                         </table>                                         </td>
                                         <td>
                                         <table width="300" border="0" cellspacing="0" cellpadding="0">
                                           <tr>
                                             ...
                                             <td class="textos"><input type="text" value="<?php echo $row_rs_query01['num_eje']?>" name="num_eje"/></td>
                                           </tr>
                                           <tr>
                                             <td width="140" height="26" class="textos">Distancia entre Ejes (m)</td>
                                             <td class="textos"><input type="text" value="<?php echo $row_rs_query01['dist_eje']?>" name="dist_eje"/></td>
                                           </tr>
                                           <tr>
                                             <td width="140" height="26" class="textos">Peso Bruto</td>
                                             <td class="textos"><input type="text" value="<?php echo $row_rs_query01['pes_bru']?>" name="pes_bru"/></td>
                                           </tr>
                                           <tr>
                                             <td width="140" height="26" class="textos">Capacidad de Carga</td>
                                             <td class="textos"><input type="text" value="<?php echo $row_rs_query01['cap_car']?>" name="cap_car"/></td>
                                           </tr>
                                           <tr>
                                             <td width="140" height="26" class="textos">Peso Neto</td>
                                             <td class="textos"><input type="text" value="<?php echo $row_rs_query01['pes_net']?>" name="pes_net"/></td>
                                           </tr>
                                           <tr>
                                             <td width="140" height="26" class="textos">Formula Rodante</td>
                                             <td class="textos"><input type="text" value="<?php echo $row_rs_query01['for_rod']?>" name="for_rod"/></td>
                                           </tr>
                                         </table>                                         </td>
                                       </tr>
                                       <tr>
                                       ...
                                       <tr>
                                         ...
                                         <table width="300" border="0" cellspacing="0" cellpadding="0">
                                           <tr>
                                             ...
                                             <td class="textos"><input type="text" value="<?php echo $row_rs_query01['cilindrada']?>" name="cilindrada"/></td>
                                           </tr>
                                           <tr>
                                             <td width="140" height="26" class="textos">Neumáticos</td>
                                             <td class="textos"><input type="text" value="<?php echo $row_rs_query01['neumaticos']?>" name="neumaticos"/></td>
                                           </tr>
                                           <tr>
                                             <td width="140" height="26" class="textos">Tracción</td>
                                             <td class="textos"><input type="text" value="<?php echo $row_rs_query01['traccion']?>" name="traccion"/></td>
                                           </tr>
                                         </table>                                         </td>
                                         <td>
                                         <table width="300" border="0" cellspacing="0" cellpadding="0">
                                           <tr>
                                             ...
                                             <td class="textos"><input type="text" value="<?php echo $row_rs_query01['pot_max']?>" name="pot_max"/></td>
                                           </tr>
                                           <tr>
                                             <td width="140" height="26" class="textos">Número de Ruedas</td>
                                             <td class="textos"><input type="text" value="<?php echo $row_rs_query01['num_rue']?>" name="num_rue"/></td>
                                           </tr>
                                           <tr>
                                             <td width="140" height="26" class="textos">Tipo de Caja</td>
                                             <td class="textos"><input type="text" value="<?php echo $row_rs_query01['tip_caj']?>" name="tip_caj"/></td>
                                           </tr>
                                         </table></td>
                                       </tr>
                    ...
                    <table>
                              <tr>
                                <td>
                                <div id="mypopup1" name="mypopup1" style='position: absolute; width: 360px; height: 100px; top:180px; left:100px; display: none; background: #eee; border: 1px solid #000;'>
						...
						<table width="240" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <form action="ingreso-producto31.php" method="post"  name="frm31" id="frm31" enctype="multipart/form-data">
                              ...
                              <input type="hidden" value="1" name="num_foto" />
                        ...
                        <div id="mypopup2" name="mypopup2" style='position: absolute; width: 360px; height: 100px; top:180px; left:100px; display: none; background: #eee; border: 1px solid #000;'>
                            <? $url = $_SERVER['PHP_SELF'] . "?" . $_SERVER['QUERY_STRING'];  ?>
						<table width="240" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td height="26" align="center">
                            ...
                            <form action="ingreso-producto32.php" method="post"  name="frm2" id="frm2" enctype="multipart/form-data">
                              <input type="hidden" value="<? echo $id_pro?>" name="id_pro" />
                              <input type="hidden" value="2" name="num_foto" />
                              <input name="urlOrigen" type="hidden" id="urlOrigen" value="<? echo $url ?>" />
                              <table width="400" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                              <td height="50">&nbsp; &nbsp;</td>
                        ...
                        <div id="mypopup3" name="mypopup3" style='position: absolute; width: 360px; height: 100px; top:180px; left:100px; display: none; background: #eee; border: 1px solid #000;'>
                            <? $url = $_SERVER['PHP_SELF'] . "?" . $_SERVER['QUERY_STRING'];  ?>
						<table width="240" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td height="26" align="center">
                            ...
                            <form action="ingreso-producto33.php" method="post"  name="frm3" id="frm3" enctype="multipart/form-data">
                              <input type="hidden" value="<? echo $id_pro?>" name="id_pro" />
                              <input type="hidden" value="3" name="num_foto" />
                              <input name="urlOrigen" type="hidden" id="urlOrigen" value="<? echo $url ?>" />
                              <table width="400" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                              <td height="50">&nbsp; &nbsp;</td>
                        ...
                        <div id="mypopup4" name="mypopup4" style='position: absolute; width: 360px; height: 100px; top:180px; left:100px; display: none; background: #eee; border: 1px solid #000;'>
                            <? $url = $_SERVER['PHP_SELF'] . "?" . $_SERVER['QUERY_STRING'];  ?>
						<table width="240" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td height="26" align="center">
                            ...
                            <form action="ingreso-producto34.php" method="post"  name="frm4" id="frm4" enctype="multipart/form-data">
                              <input type="hidden" value="<? echo $id_pro?>" name="id_pro" />
                              <input type="hidden" value="4" name="num_foto" />
                              <input name="urlOrigen" type="hidden" id="urlOrigen" value="<? echo $url ?>" />
                              <table width="400" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                              <td height="50">&nbsp; &nbsp;</td>
                        ...
                        <div id="mypopup5" name="mypopup5" style='position: absolute; width: 360px; height: 100px; top:180px; left:100px; display: none; background: #eee; border: 1px solid #000;'>
                            <? $url = $_SERVER['PHP_SELF'] . "?" . $_SERVER['QUERY_STRING'];  ?>
						<table width="240" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td height="26" align="center">
                            ...
                            <form action="ingreso-producto35.php" method="post"  name="frm5" id="frm5" enctype="multipart/form-data">
                              <input type="hidden" value="<? echo $id_pro?>" name="id_pro" />
                              <input type="hidden" value="5" name="num_foto" />
                              <input name="urlOrigen" type="hidden" id="urlOrigen" value="<? echo $url ?>" />
                              <table width="400" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                              <td height="50">&nbsp; &nbsp;</td>
                        ...
                        <div id="mypopup6" name="mypopup6" style='position: absolute; width: 360px; height: 100px; top:180px; left:100px; display: none; background: #eee; border: 1px solid #000;'>
                            <? $url = $_SERVER['PHP_SELF'] . "?" . $_SERVER['QUERY_STRING'];  ?>
						<table width="240" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td height="26" align="center">
                            ...
                            <form action="ingreso-producto36.php" method="post"  name="frm6" id="frm6" enctype="multipart/form-data">
                              <input type="hidden" value="<? echo $id_pro?>" name="id_pro" />
                              <input type="hidden" value="6" name="num_foto" />
                              <input name="urlOrigen" type="hidden" id="urlOrigen" value="<? echo $url ?>" />
                              <table width="400" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                              <td height="50">&nbsp; &nbsp;</td>
                        ...
                        <div id="mypopup7" name="mypopup7" style='position: absolute; width: 360px; height: 100px; top:180px; left:100px; display: none; background: #eee; border: 1px solid #000;'>
                            <? $url = $_SERVER['PHP_SELF'] . "?" . $_SERVER['QUERY_STRING'];  ?>
						<table width="240" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td height="26" align="center">
                            ...
                            <form action="ingreso-producto37.php" method="post"  name="frm7" id="frm7" enctype="multipart/form-data">
                              <input type="hidden" value="<? echo $id_pro?>" name="id_pro" />
                              <input type="hidden" value="7" name="num_foto" />
                              <input name="urlOrigen" type="hidden" id="urlOrigen" value="<? echo $url ?>" />
                              <table width="400" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                              <td height="50">&nbsp; &nbsp;</td>
                        ...
                        <div id="mypopup8" name="mypopup8" style='position: absolute; width: 360px; height: 100px; top:180px; left:100px; display: none; background: #eee; border: 1px solid #000;'>
                            <? $url = $_SERVER['PHP_SELF'] . "?" . $_SERVER['QUERY_STRING'];  ?>
						<table width="240" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td height="26" align="center">
                            ...
                            <form action="ingreso-producto38.php" method="post"  name="frm8" id="frm8" enctype="multipart/form-data">
                              <input type="hidden" value="<? echo $id_pro?>" name="id_pro" />
                              <input type="hidden" value="8" name="num_foto" />
                              <input name="urlOrigen" type="hidden" id="urlOrigen" value="<? echo $url ?>" />
                              <table width="400" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                              <td height="50">&nbsp; &nbsp;</td>
                        ...
                        <div id="mypopup9" name="mypopup9" style='position: absolute; width: 360px; height: 100px; top:180px; left:100px; display: none; background: #eee; border: 1px solid #000;'>
                            <? $url = $_SERVER['PHP_SELF'] . "?" . $_SERVER['QUERY_STRING'];  ?>
						<table width="240" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td height="26" align="center">
                            ...
                            <form action="ingreso-producto39.php" method="post"  name="frm9" id="frm9" enctype="multipart/form-data">
                              <input type="hidden" value="<? echo $id_pro?>" name="id_pro" />
                              <input type="hidden" value="9" name="num_foto" />
                              <input name="urlOrigen" type="hidden" id="urlOrigen" value="<? echo $url ?>" />
                              <table width="400" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                              <td height="50">&nbsp; &nbsp;</td>
                        ...
                        <div id="mypopup10" name="mypopup10" style='position: absolute; width: 360px; height: 100px; top:180px; left:100px; display: none; background: #eee; border: 1px solid #000;'>
                            <? $url = $_SERVER['PHP_SELF'] . "?" . $_SERVER['QUERY_STRING'];  ?>
						<table width="240" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td height="26" align="center">
                            ...
                            <form action="ingreso-producto40.php" method="post"  name="frm10" id="frm10" enctype="multipart/form-data">
                              <input type="hidden" value="<? echo $id_pro?>" name="id_pro" />
                              <input type="hidden" value="10" name="num_foto" />
                              <input name="urlOrigen" type="hidden" id="urlOrigen" value="<? echo $url ?>" />
                              <table width="400" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                              <td height="50">&nbsp; &nbsp;</td>
                        ...
                        <!--  fin de pop -->
                                ...
                                <!-- boton de abrir pop --><a href="#" onClick='document.getElementById("mypopup1").style.display="block"'><img src="../imagenes_producto_chica_thumbnails/<?php 
								$foto = $row_rs_query0['img_pro1'];
								if($foto<>""){
								echo $foto;
								}else{
								echo "comodin.jpg";
    ...
    <!-- fin de boton --> </td>
                                <td><a href="#" onClick='document.getElementById("mypopup2").style.display="block"'><img src="../imagenes_producto_chica_thumbnails/
								<?php 
								$foto = $row_rs_query0['img_pro2'];
								if($foto<>""){
								echo $foto;
								}else{
								echo "comodin.jpg";
                                ...
                                <td><a href="#" onClick='document.getElementById("mypopup3").style.display="block"'><img src="../imagenes_producto_chica_thumbnails/<?php 
								$foto = $row_rs_query0['img_pro3'];
								if($foto<>""){
								echo $foto;
								}else{
								echo "comodin.jpg";
								...
								?>" width="100" border="0"/></a></td>
                                <td><a href="#" onClick='document.getElementById("mypopup4").style.display="block"'><img src="../imagenes_producto_chica_thumbnails/<?php 
								$foto = $row_rs_query0['img_pro4'];
								if($foto<>""){
								echo $foto;
								}else{
								echo "comodin.jpg";
								...
								?>" width="100" border="0"/></a></td>
                                <td><a href="#" onClick='document.getElementById("mypopup5").style.display="block"'><img src="../imagenes_producto_chica_thumbnails/<?php 
								$foto = $row_rs_query0['img_pro5'];
								if($foto<>""){
								echo $foto;
								}else{
								echo "comodin.jpg";
                              ...
                              <tr>
                                <td><a href="#" onClick='document.getElementById("mypopup6").style.display="block"'><img src="../imagenes_producto_chica_thumbnails/<?php 
								$foto = $row_rs_query0['img_pro6'];
								if($foto<>""){
								echo $foto;
								}else{
								echo "comodin.jpg";
								...
								?>" width="100" border="0"/></a></td>
                                <td><a href="#" onClick='document.getElementById("mypopup7").style.display="block"'><img src="../imagenes_producto_chica_thumbnails/
								<?php 
								$foto = $row_rs_query0['img_pro7'];
								if($foto<>""){
								echo $foto;
								}else{
								echo "comodin.jpg";
								...
								?>
                                " width="100" border="0"/></a></td>
                                <td><a href="#" onClick='document.getElementById("mypopup8").style.display="block"'><img src="../imagenes_producto_chica_thumbnails/<?php 
								$foto = $row_rs_query0['img_pro8'];
								if($foto<>""){
								echo $foto;
								}else{
								echo "comodin.jpg";
								...
								?>" width="100" border="0"/></a></td>
                                <td><a href="#" onClick='document.getElementById("mypopup9").style.display="block"'><img src="../imagenes_producto_chica_thumbnails/<?php 
								$foto = $row_rs_query0['img_pro9'];
								if($foto<>""){
								echo $foto;
								}else{
								echo "comodin.jpg";
								...
								?>" width="100" border="0"/></a></td>
                                <td><a href="#" onClick='document.getElementById("mypopup10").style.display="block"'><img src="../imagenes_producto_chica_thumbnails/<?php 
								$foto = $row_rs_query0['img_pro10'];
								if($foto<>""){
								echo $foto;
								}else{
								echo "comodin.jpg";
