...
$query1 = "select * from producto where id_cat='$id_cat' and id_subcat='$id_subcat'";
...
$query2 = "delete from producto where id_cat='$id_cat' and id_subcat='$id_subcat'";
mysql_query($query2, $cn) or die(mysql_error());
$query3 = "delete from subcategoria where id_cat='$id_cat' and id_subcat='$id_subcat'";
mysql_query($query3, $cn) or die(mysql_error());
header("Location:borrar-subcategoria1.php?cod_prod=".$id_pro."&ok=ok");
?>