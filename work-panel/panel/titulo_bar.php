<div class="bloque_titulo">
    ...
    if(!($datos_tabla['crear']=='0' or $tblistadosize=='0' )){
        ...
        if(!isset($_GET['i'])){
            ...
            <span id="abri_cerrar_crear">
                <a href="custom/<?php echo $SERVER['URL'];?>#create" id="abrir_crear" onclick="abrir_crear('1','0');" class="btn btn-small btn-primary" 
                style=" <?php echo ($saved[$datos_tabla['me']]['crearopen']=='1')?"display:none;":""?>" >
                    <i class="itr ico_crea"></i>
                    crear <?php echo $datos_tabla['nombre_singular']?>
                </a>
                <a href="custom/<?php echo $SERVER['URL'];?>#list" id="cerrar_crear" onclick="abrir_crear('0','0');" class="btn btn-small btn-inverse" 
                style=" <?php echo ($saved[$datos_tabla['me']]['crearopen']=='1')?"":"display:none;"?>" >
                    cancelar crear
                </a>
            </span>
    ...
    */
    ...
    if($datos_tabla['exportar_excel']=='1'){
        ...
        <a href="#" id="boton_excel" onclick="javascript:ax('excel');return false;" class="btn btn-small" title="Descargar Excel"><i class="itl ico_Excel"></i>Exportar Excel</a>
        <?php
