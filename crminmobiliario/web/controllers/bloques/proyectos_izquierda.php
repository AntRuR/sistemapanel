...
if($proyecto['id_grupo']=='2'){ //proyectos en ejecucion
	...
	$proyecto['grupo']=$proyecto['name_subgrupo'];

	$group_query="id_subgrupo='".$proyecto['id_subgrupo']."'";
...
$object['filas']= select(
        ...
        ,"productos_items"
        ,"where 1 and $group_query and id!='".$proyecto['id']."' and  visibilidad='1' order by id asc limit 0,100"
        ,0
		,array(
