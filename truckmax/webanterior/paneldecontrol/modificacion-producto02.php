...
<tr>
            ...
            <form action="" method="post" name="frm2">            
              <table width="600" border="0" cellspacing="6">
                ...
                <tr>   
                  <td colspan="5" align="center" class="titulo"><strong>PRODUCTOS EXISTENTES</strong></td>           
                </tr>            
                <tr>
                  <td class="titulo">&nbsp;</td>            
            ...
            ?>
                <tr>
                  ...
                  <td><a href="modificacion-producto2.php?id_pro=<?php echo $row_rs_query0['id_pro']; ?>&id_subcat=<? echo $tipomarc ?>&nom_pro=<?php echo $row_rs_query0['nom_pro_es']?>&id_formato=<?php echo $row_rs_query0['id_formato']; ?>" target="_SELF" class="login">edit</a></td>
                </tr>
                <?php
