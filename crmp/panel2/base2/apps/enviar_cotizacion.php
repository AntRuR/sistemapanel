	...
	$pblocks[]=render_cliente($linea);
		...
		$Producto=str_replace("\\\"","\"",$html);
			...
			if($_SERVER['REQUEST_METHOD']=='POST'){
				...
				"<a href='".$vars_server['httpfiles']."/index.php?modulo=items&tab=productos_imprimir&acc=file&id_mensaje=".$insertado_mensaje['id']."&id_usuario=".$linea['id_usuario']."'>IMPRIMIR</a>",								 
										 		),$_POST['msg']);
									update(array(
												'texto'=>$_POST['msg'],
												),
		...
		$tbcampos=array(
						...
						'texto'			=>array(
							...
							'variables'		=> array(		
								...
								'IMPRIMIR'          =>str_replace("'","\"","<a href='$dominio/cotizacion/".$linea['id']."'>IMPRIMIR</a>"),
