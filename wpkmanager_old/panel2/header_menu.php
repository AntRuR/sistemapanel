<div class='menus' style='margin:0;' >
<?php
...
if(file_exists($url_publica0[0])) {
    ...
    echo "<a href='".str_replace("127.0.0.1","localhost",$url_publica)."' target='_top' ></span>WEB</a>";
...
if($Open or $Local==1){
    ...
    if( $VALIDAR_SESION!='' /*or $_SESSION['usuario_id']!=''*/ ){
        ...
        echo "<a style='text-transform:uppercase;' ". (($script_name=="maquina.php")?"class='selected'":"") ." href='maquina.php?redirhome=1' ></span>MASTER</a>";

    } else {


        echo "<li class='menudown'>";
        echo "<a href='maquina.php'>MASTER</a>";
...
if( $VALIDAR_SESION!='' and $_SESSION['usuario_id']!='' ){
    ...
    echo "<a href='salir.php'></span>salir</a>";
    //	$tabla_usuarios
    ...
    if((strpos($_SERVER['SCRIPT_NAME'], "login.php")===false)){
        ...
        if($_SESSION['usuario_datos_id']){
            echo ($_SESSION['usuario_datos_nombre'])?"<strong class='z'>". $_SESSION['usuario_datos_nombre'] ."</strong>":'';
        }else{
            //$mmmM.=  "<strong>". dato($sesion_login,$tabla_sesion,"where $sesion_id='".$_SESSION['usuario_id']."'") ."</strong>";
            echo  "<strong class='z'>". $_SESSION['usuario_datos_nombre'] ."</strong>";
        }
        //$mmmM.= "</a>";
    ...
    // JEFE
    echo  ($_SESSION['usuario_datos_nombre_grupo'])?"<li class='m_grupo'><strong class='z'>". $_SESSION['usuario_datos_nombre_grupo'] ."</strong></li>":'';
...
// $hhtml ='';
// $hhtml.="<div class='menus' style='margin:0;' >";
