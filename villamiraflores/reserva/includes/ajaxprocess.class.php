...
class ajaxProcessor
{
	...
	public function getCustomerDetails(){
		...
		$client_sql=mysql_query("select * from bsi_clients where email='".$existing_email."' and password='".md5($login_password)."' limit 1");
	...
	public function forgetpassword(){
		...
		if(mysql_num_rows($client_sql)){
			include("includes/mail.class.php");
					...
					mysql_query("update bsi_clients set password='".md5($temp_password)."' where email='".$existing_email."'" );
