...
$objeto_tabla['VENTAS_ITEMS']=array(
		...
		'postscript'	=> '
				...
				if(SS=="insert"){
					...
					update(array("id_jefe"=>$jefe ,"vendedor_status"=>$usu_status),TT,"where id=II",0);

					update(array("id_jefe"=>$jefe ,"vendedor_status"=>$usu_status ,"id_usuario"=>LL["id_usuario"]),"clientes","where id=".LL["id_cliente"],0);
...
$objeto_tabla['VENTAS_MENSAJES']=array(
		...
		'orden'			=> '0',
		'postscript'	=> '
				$linea=fila("id_jefe,id_usuario","ventas_items","where id=".LL["id_grupo"],0);
				if(SS=="update" or SS=="insert"){
					update(array("id_status"=>LL["id_status"]),"ventas_items","where id=".LL["id_grupo"],0);
					update(array("id_jefe"=>$linea["id_jefe"],"id_usuario"=>$linea["id_usuario"]),TT,"where id=".II,0);
				}
		',
		'app'			=> '
