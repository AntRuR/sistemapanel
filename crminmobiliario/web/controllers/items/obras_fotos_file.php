...
$object=array_merge($object, paginacion(
			...
			,array(
				...
				'foto:atributos'=>array('atributos'=>'obrfot_imas,{fecha_creacion},{file},1,150x110,1'),
				'foto:url'=>array('archivo'=>'obrfot_imas,{fecha_creacion},{file},4'),
...
$object['panel']=array('OBRAS_FOTOS','OBRAS_FOTOS_FOTOS');
//////////////////////CONECTOR/////////////
