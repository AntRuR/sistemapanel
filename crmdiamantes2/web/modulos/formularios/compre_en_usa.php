	...
	,'pag_factura_telefono'=>array(
		...
		,'tipo'=>'input_text'
			...
			$FORM=$FORMULARIO[$PARAMS['conector']]=array(
					...
					,'email_admin'=>array('usa@olvacompras.com')
...
/*CAMPOS-END*/
	...
	////////////body_cliente
				...
				$body_cliente.="Has enviado solicitud de compra a ".$PARAMETROS_EMAIL['nombre_web']." con los siguienes datos:<br><br><br>";
				...
				$email_cliente=enviar_email(
								...
								,'Subject'=>"Solicitud de ".$PARAMETROS_EMAIL['nombre_web']
								,'body'=>$body_cliente
								//,'From'=>'info@afarmach.com'
								//,'FromName'=>'Afarmach'							
								//,'Logo'=>''
