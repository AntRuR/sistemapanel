...
$objeto_tabla['PAGINAS_GROUPS']=array(
		...
		'campos'		=>array(
				...
				'url'		=>array(
						...
						'validacion'	=> '1',
						// 'constante'		=> '1',
						'setup'			=> 'empresa,servicios,asociados,otras',
				),								
				'name'		=>array(
						'campo'			=> 'name',
						'label'			=> 'Nombre',
...
$objeto_tabla['PAGINAS']=array(
		...
		<a href="custom/paginas.php?id=3">Asociados</a>
		<a href="custom/paginas.php?id=4">Páginas Informativas</a>
...
$objeto_tabla['VARIABLES']=array(
		...
		'campos'		=>array(
				...
				'variable'		=>array(
						...
						'constante'		=> '1',
						'width'			=> '300px',
						'setup'			=> 'url_facebook,url_twitter'
				),
				'valor'			=>array(
						'campo'			=> 'valor',
						'label'			=> 'Valor',
