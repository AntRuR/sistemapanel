...
$objeto_tabla['PRODUCTOS_GROUPS']=array(
		'titulo'		=> '{select name from productos_groups where id=[id]}',
		'nombre_singular'=> 'grupo de productos',
		'nombre_plural'	=> 'grupos de producto',
		...
		'campos'		=>array(
				...
				'id_grupo'		=>array(
						...
						'opciones'		=> 'id,name|productos_groups|where id_grupo=0'
				),					
				'weight'		=>array(
						'campo'			=> 'weight',
						'label'			=> 'Peso',
