...
<div class='groups'
	...
	<li class="linea_form legend"><?php echo $tbcampA['legend'];?></li>
	<?php }
...
*/
	...
	// ';
				...
				echo ($tbcampA['button_app'])?'<a rel="width:1400,height:720" id="in_'.$tbcampA['campo'].'_button" class="mb z crearforeig" style="float:right !important;margin:0 !important;" href="'.$tbcampA['button_app'].'"></a>':"";
				if($mostrarli){
				?></li>
	<?php
	}
