...
$objeto_tabla['PAGINAS']=array(
		...
		<a href="custom/galleries_photos_photos.php?id=1">Promociones</a>
...
$objeto_tabla['PROJECTS']=array(
		...
		'campos'		=>array(
				...
				'name'		=>array(
						...
						'style'			=> 'width:75%;',
						'controles'		=> '
<a rel="subs" href="custom/project_galleries_photos.php?id_grupo=[id]">{select count(*) from project_galleries_photos where id_grupo=[id]} Galerías</a>
<a rel="subs" href="custom/projects.php?id_grupo=[id]">{select count(*) from projects where id_grupo=[id]} servicios</a>
',							
				),
				// 'status'	=>array(
				// 		'campo'			=> 'status',
