...
$file_size = $_FILES['v_file_'.$_GET['tb'].'_'.$_GET['camp']]['size'];
$file_type = $_FILES['v_file_'.$_GET['tb'].'_'.$_GET['camp']]['type'];
$file_temp = $_FILES['v_file_'.$_GET['tb'].'_'.$_GET['camp']]['tmp_name']; 
$exA=explode(".",$_FILES['v_file_'.$_GET['tb'].'_'.$_GET['camp']]['name']);
...
//	            mysql_close($conn);
	            ?>
	            <script>
	            parent.upload_terminar("<?php echo $httpfiles.$folder_dest.'/'.date("Y").'/'.date("m").'/'.date("d").'/'.$file_dest_preview ?>",'<?php echo $tb?>','<?php echo $campo?>',"<?php echo $httpfiles.$folder_dest.'/'.date("Y").'/'.date("m").'/'.date("d").'/'.$file_dest_orig ?>");
	        ...
	        {
	            ?>
	            <script>parent.upload_err('<?php echo _("intente de nuevo.")?>','<?php echo $tb?>','<?php echo $campo?>');</script>
	            <?php
	        }
	    }
	    else
    ...
    else
    {
	        ?>
	        <script>
	        parent.upload_err('<?php echo _("No es un fichero de imágen válido")?>','<?php echo $tb?>','<?php echo $campo?>');
	        </script>
	        <?php
    }
}
