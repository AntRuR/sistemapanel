...
$HEAD['INCLUDES']['style_common'][]='#contenido_margen { margin: 0px; border:'. $ContenidoBorde .'px solid #FFF; border-bottom:0;  float:none; #float:left; padding-left:'.$WV['content_p-i'].';padding-right:'.$WV['content_p-d'].';'.$WV['content_s'].' }';
