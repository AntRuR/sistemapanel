...
<html xmlns="http://www.w3.org/1999/xhtml"><head><title>Sistema de Envio</title><meta content="text/html; charset=UTF-8" http-equiv="content-type"/><meta name="title" content="Administrador de Contenido"/><meta name="description" content="Administrador de Contenido 1.1"/><meta name="keywords" content="Prodiserv"/><link rel="stylesheet" type="text/css" href="../css/MooEditable.css"><link rel="stylesheet" type="text/css" href="../css/MooEditable.Extras.css"><link rel="stylesheet" type="text/css" href="../css/MooEditable.SilkTheme.css"><link rel="stylesheet" type="text/css" href="../css/MooEditable.Table.css"><link rel="stylesheet" type="text/css" href="../css/bootstrap.css">
<?php $sn2='../';?><script type="text/javascript" src="<?php echo $sn2?>js/mootools-core-1.3.2-full-compat.js"></script><?php?><script type="text/javascript" src="<?php echo $sn2?>js/mootools-more-1.3.2.1.js"></script><?php?><script type="text/javascript" src="<?php echo $sn2?>js/js.js"></script><?php?><script type="text/javascript" src="<?php echo $sn2?>js/MooEditable.js"></script><?php?><script type="text/javascript" src="<?php echo $sn2?>js/MooEditable.UI.ButtonOverlay.js"></script><?php?><script type="text/javascript" src="<?php echo $sn2?>js/MooEditable.UI.MenuList.js"></script><?php?><script type="text/javascript" src="<?php echo $sn2?>js/MooEditable.Extras.js"></script><?php?><script type="text/javascript" src="<?php echo $sn2?>js/MooEditable.Table.js"></script><?php?><script type="text/javascript" src="<?php echo $sn2?>js/MooEditable.CleanPaste.js"></script><?php?>
