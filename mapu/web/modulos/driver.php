...
$Estructura['modulo=items&tab={obras_fotos,obras_fotos2}']=
array(
	'header'=>$Block['header'],
//	"bloques/print_marquesina.php",
	 array(
...
$Estructura['modulo=items&tab={bloque_centro}']=
array(
	'header'=>$Block['header'],	
//	"bloques/print_marquesina.php",
	 array(
...
$Estructura['modulo=items&tab=turismo_fotos']=
array(
	'header'=>$Block['header'],	
//	"bloques/print_marquesina.php",
	 array(
		'bloques/menu_turismo.php',		//
		"MAIN?classStyle=pages",						//panel:textos_items
		//$Block['bar_derecha'],		//
		),
	'footer'=>$Block['footer'],
...
$Estructura['modulo=items&tab=convocatoria_items']=
array(
	'header'=>$Block['header'],
//	"bloques/print_marquesina.php",
	 array(
		'bloques/menu_convocatoria.php',		//
		"MAIN?classStyle=pages",						//panel:textos_items
		$Block['bar_derecha'],		//
		),
	'footer'=>$Block['footer'],		
...
$Estructura['modulo=items&tab=tramites_items']=
array(
	'header'=>$Block['header'],
//	"bloques/print_marquesina.php",
	 array(
		'bloques/menu_tramites.php',		//
		"MAIN?classStyle=pages",						//panel:textos_items
		$Block['bar_derecha'],		//
		),
	'footer'=>$Block['footer'],		
...
$Estructura['modulo=items&tab=centro_grupos']=
array(
	'header'=>$Block['header'],
//	"bloques/print_marquesina.php",
	 array(
		'bloques/menu_centro.php',		//
		"MAIN?classStyle=pages",						//panel:textos_items
		$Block['bar_derecha'],		//
		),
	'footer'=>$Block['footer'],		
...
$Estructura['modulo=app&tab=enlinea']=
array(
	'header'=>$Block['header'],	
	 array(
		$Block['bar_izquierda'],//
