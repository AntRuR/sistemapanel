...
?>
<div>
	<h1 style="font-weight: bold; clear: left;">DOCUMENTOS</h1>
</div>

<ul>
	<li><a href="https://tickets.hostgator.com" target="_blank">HOSTGATOR
			TICKET</a> (guillermolozan@gmail.com|platano)</li>

	<br />
	<ul>
		<li><a href="http://www.google.com/a/cpanel/standard/new"
			target="_blank">INCRIBIR EN GOOGLE APPS STANDARD</a>
			(Walter|Távara|guillermolozan@gmail.com|2614506|||administrador|<?php echo $vars['REMOTE_FTP']['ftp_files_pass'];?>)</li>
		<li><a href="maquina.php?accion=crear_archivo_verificacion">crear
				archivo de verificación de dominio, redirección de email e imágen
				para email</a> (archivo:googlehostedservice.html,
			contenido:googleb286641876ac8feb)</li>
		<li><a
			href="<?php echo $vars['REMOTE']['url_publica']."/googlehostedservice.html";?>"
			target="_blank">verificar dominio</a></li>
		<li>Adicionalmente : Personalización del dominio [ General,Apariencia
			( imagen de gif o png de 143x159) ]</li>
		<li><a
			href="https://www.google.com/a/<?php echo $vars['REMOTE_FTP']['ftp_files_host'];?>"
			target="_blank">https://www.google.com/a/<?php echo $vars['REMOTE_FTP']['ftp_files_host'];?>
		</a></li>
		<li><a
			href="http://mail.google.com/a/<?php echo $vars['REMOTE_FTP']['ftp_files_host'];?>"
			target="_blank">http://mail.google.com/a/<?php echo $vars['REMOTE_FTP']['ftp_files_host'];?>
		</a></li>
		<li><a
			href="http://<?php echo $vars['REMOTE_FTP']['ftp_files_host'];?>/email"
			target="_blank">http://<?php echo $vars['REMOTE_FTP']['ftp_files_host'];?>/email
		</a></li>

		<li><a href="maquina.php?accion=enviar_email_password&gmail=1&panel=1">Enviar
				email con password ( FTP | PANEL | GMAIL )</a></li>
		<li><a href="maquina.php?accion=enviar_email_password&gmail=1&panel=0">Enviar
				email con password ( FTP | GMAIL )</a></li>
		<li><a href="maquina.php?accion=enviar_email_password&gmail=0&panel=1">Enviar
				email con password ( FTP | PANEL )</a></li>
		<li><a href="maquina.php?accion=enviar_email_password&gmail=0&panel=0">Enviar
				email con password ( FTP )</a></li>
		<br />
		<li><a
			href="http://<?php echo $vars['REMOTE_FTP']['ftp_files_host'];?>:2082"
			target="_blank">CPANEL</a> (<?php echo $vars['REMOTE_FTP']['ftp_files_user'];?>|<?php echo $vars['REMOTE_FTP']['ftp_files_pass'];?>)
			crear [panel|guillermo|lozan159357]</li>
		<br />

		<li>Herramientas Google</li>

		<li><a href="https://www.google.com/analytics/settings/?hl=es"
			target="_blank">GOOGLE ANALYTICS</a></li>

		<li><a href="http://www.google.com/insights/search/#" target="_blank">GOOGLE
				INSIGHT</a></li>

		<li><a href="http://www.google.com/wave" target="_blank">GOOGLE WAVE</a>
		</li>

		<br />
		<li><a
			href="http://mail.google.com/support/bin/answer.py?hl=es&ctx=mail&answer=12103">CONFIGURACION
				DE GMAIL PARA CLIENTES POP</a>POP3|pop.gmail.com|smtp.gmail.com|(SMTP)465|(POP3)995</li>
		<li><a href="https://secure.hostgator.com/billing/" target="_blank">HOSTGATOR
				BILLING</a> (guillermolozan@gmail.com|platano)</li>
		<li><a href="http://forums.hostgator.com/" target="_blank">HOSTGATOR
				FORUM</a> (guillermolozan|platano)</li>
	</ul>
	<br />
	<h2>CPANEL X</h2>
	<li><a
		href="http://<?php echo $vars['REMOTE_FTP']['ftp_files_user'];?>:<?php echo $vars['REMOTE_FTP']['ftp_files_pass'];?>@<?php echo $vars['REMOTE_FTP']['ftp_files_host'];?>2082/frontend/x/index.html"
		target="_blank">CPANEL</a> | <a
		href="http://<?php echo $vars['REMOTE_FTP']['ftp_files_user'];?>:<?php echo $vars['REMOTE_FTP']['ftp_files_pass'];?>@<?php echo $vars['REMOTE_FTP']['ftp_files_host'];?>:2082/frontend/x/sql/index.html"
		target="_blank">DATABASE</a> | <a
		href="http://<?php echo $vars['REMOTE_FTP']['ftp_files_user'];?>:<?php echo $vars['REMOTE_FTP']['ftp_files_pass'];?>@<?php echo $vars['REMOTE_FTP']['ftp_files_host'];?>:2082/frontend/x/cron/advcron.html"
		target="_blank">CRON</a> | <a
		href="http://<?php echo $vars['REMOTE_FTP']['ftp_files_user'];?>:<?php echo $vars['REMOTE_FTP']['ftp_files_pass'];?>@<?php echo $vars['REMOTE_FTP']['ftp_files_host'];?>:2082/3rdparty/phpMyAdmin/index.php"
		target="_blank">PHPMYADMIN</a>
	</li>

	<h2>CPANEL RVBLUE</h2>
	<li><a
		href="http://<?php echo $vars['REMOTE_FTP']['ftp_files_user'];?>:<?php echo $vars['REMOTE_FTP']['ftp_files_pass'];?>@<?php echo $vars['REMOTE_FTP']['ftp_files_host'];?>:2082/frontend/rvblue/index.html"
		target="_blank">CPANEL</a> | <a
		href="http://<?php echo $vars['REMOTE_FTP']['ftp_files_user'];?>:<?php echo $vars['REMOTE_FTP']['ftp_files_pass'];?>@<?php echo $vars['REMOTE_FTP']['ftp_files_host'];?>:2082/frontend/rvblue/sql/managedbs.html"
		target="_blank">DATABASE</a> | <a
		href="http://<?php echo $vars['REMOTE_FTP']['ftp_files_user'];?>:<?php echo $vars['REMOTE_FTP']['ftp_files_pass'];?>@<?php echo $vars['REMOTE_FTP']['ftp_files_host'];?>:2082/frontend/rvblue/cron/index.html"
		target="_blank">CRON</a> | <a
		href="http://<?php echo $vars['REMOTE_FTP']['ftp_files_user'];?>:<?php echo $vars['REMOTE_FTP']['ftp_files_pass'];?>@<?php echo $vars['REMOTE_FTP']['ftp_files_host'];?>:2082/3rdparty/phpMyAdmin/index.php?lang=en-utf-8"
		target="_blank">PHPMYADMIN</a>
	</li>
	<li><a href="http://templates.hostgator.com/" target="_blank">TEMPLATES
			HOSTGATOR</a></li>
	<li>TENDENCIAS MUNDIALES EN EL MUNDO DE ANUCIONES : http://adage.com/</li>

	<li>para buscar MP3 ( "michael jackson" intitle:index.of mp3 -html -htm
		-php -asp -txt -pls )</li>
</ul>
...
1-MENU :: comoon.php																								ok

</pre>
	<img src="img/menu_map.jpg" width="350" />
	<pre>

2-ICO  :: templates/default/img/favicon.ico	:: ( http://www.favicon.cc/ )											ok

3-CSS  :: css.php																									ok
    BODY {bg:#000,w:972,font:trebushe,head-h:201,head-bottom-10,headpre-h,headpost-h,footpre-h,foot-h,footpost-h}
    CANVAS {min-h:350,bg:#FFF,intercol:5,dbl:178M,tpl:178M100,cpl:150|150M150,borde:1}

4-LISTADO :: tablas.php :: 100x200,109x128,600x400																	ok
    template/default/items.php
    modulos/items/#ITEMS#_list.php
    template/default/items/#ITEMS#_list.php
...
COMMON:
    M: common.php
    T: common/{head.php, header_pre.php, header.php, header_after.php, menu.php, footer_pre.php , footer.php, footer_after.php}
FORMULARIOS:
	M: driver.php	-> formularios/formularios.php -> formularios/[contacto|recomendar|pedido|registro|login|cerrar|#formulario].php
    T: formularios/[contacto|recomendar|pedido|registro|login|cerrar|#formulario].php
APP:
	M: driver.php	-> app/[home|page|carrito|#app].php
    T: app.php		-> app/[home|page|carrito|#app].php
ITEMS:
	M: driver.php	-> items/{#items.php, #items_file.php, #items_file.php}
    T: items.php	-> items/{			 #items_file.php, #items_file.php}

BLOQUES:
	M: bloques/[ ]
    T: bloques/[ ]
ERROR:
    T: error.php	->error/error_main.php]
