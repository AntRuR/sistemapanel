...
if($row_rs_query1['des_destal']==""){
	...
	do{
		echo 	"<tr>
					...
					<td><a href='ingreso-talla4.php?talla=".$row_rs_query1['id_tal']."&talladescripcion=".$row_rs_query1['id_taldes']."&url=borrar-talla1'><img src='imagenes/eliminar.jpg' border='0' /></a></td>
				</tr>";			
