...
function web_render_edit_toolbar($SELS){
	...
	.markarselected {
		...
		z-index:1000; position:relative; z-index:5000;
		overflow:visible;
	}
...
function css_render_esquinas($ID,$DIR,$opciones){
	...
	case "barra_abajo": $derLong=1; $lineas[]=".$ID .$file { background-image: url(\"".$file0."\"); background-repeat:repeat-x; height:".$size[1]."px; background-position:left bottom;}"; break;
