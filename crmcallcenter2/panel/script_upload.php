...
//	            mysql_close($conn);
	            ?>
	            <script>
	            parent.upload_terminar("<?php echo $httpfiles.$folder_dest.'/'.date("Y").'/'.date("m").'/'.date("d").'/'.$file_dest_preview ?>",'<?php echo $tb?>','<?php echo $campo?>',"<?php echo $httpfiles.$folder_dest.'/'.date("Y").'/'.date("m").'/'.date("d").'/'.$file_dest_orig ?>"<?php echo ($objeto_tabla[$_GET['obj']]['crear_quick']=='1')?",'1'":''?>);
