...
if($_GET['id_item']!=''){
	...
	echo render_table($row,'reporte_ventas reporte_corto');
	...
	//HEADER
	$l=0;
	$row[$l][]=array('VALOR DE VENTA TOTAL S/.' .( ( $_GET['format']=='excel' )?'':'<a class="linkstitu itr ico_Excel" title="Descargar Excel" href="'.$SERVER['URL'].'&seccion=TABLA2&format=excel">Exportar Excel</a>'),'class=nombre colspan=2','class=success');
