...
if(isset($_SESSION['publicar']['usuario_temp'])){
	...
	*/
	...
	$PUBLICAR_1['LINK'] = procesar_url('index.php?modulo=formulario&tab=publicar-anuncio-1'.web_follow_url(array('id_departamento','id_provincia','id_distrito','id_grupo','id_subgrupo')));
...
if($_SESSION['login']['status']==1){
	...
	$FORMULARIO['publicar-anuncio-2']['url']="index.php?modulo=static&tab=final-publicacion";

} else {

	$FORMULARIO['publicar-anuncio-2']['submit']=' type="image" src="'.$SERVER['BASE'].THEME_PATH.'img/ico_siguiente.jpg" ';
	$FORMULARIO['publicar-anuncio-2']['url']='index.php?modulo=formulario&tab=registro';
