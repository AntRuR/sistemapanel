...
//do{
//
//	$equival[$i]=$row_rs_query1["equivalencia"];
//	$valor_equi=$$equival[$i];
...
function mostrarMarcadores(valor){
	ObtenerDatos('modificacion-marcadorequivalencia2.php?tipomarcador='+valor+'&fecha='+Date(),'marcadoresmaster');
}
</script>
<style type="text/css">
body {
    ...
    <td align="center" valign="top"><table width="900" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <table width="900" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td class="texto">
            <form action="modificacion-equivalencia1-2.php" method="post" name="frm2">      
              <table border="0" cellspacing="6">
                ...
                <tr>
                  <td align="left" class="titulo">Equivalencia</td>
                </tr>
                <tr>
                  <td align="left"><p>
                    <input name="equivalC" type="text" class="texto" value="<?php echo $equival[0]?>">
                  </p>
                    <p>
                      <label></label>
</p></td>
