<?php
	...
	// ================================================
	// Revision: 1.3.1                 Date: 11/01/2005
	// ================================================
...
/*		array (
	...
	$cfg['ilibs'] = array (	// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions	
		array (																		
			'value'   	=> $_SESSION["dirrecursosimages"],												
			'text'    	=> 'Imagenes',
		),
		array (
			'value'   	=> $_SESSION["dirrecursosgalerias"], 				
			'text'    	=> 'Galerias',
		),	
	);
	//-------------------------------------------------------------------------
	...
	// Ahora se esta usando estos directorios dinamicos (ECHM):
	$cfg['ilibs_dir'] 	   = array('/recursos/images/','/recursos/gallery/');						   	// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions
	...
	$cfg['ver'] 		= '1.3.1 - build 11012005';										// iBrowser version	
	...
	//------------------ Este codigo hasido cambiado por ECHM para controlar las imagenes de otro directorio se comenta root dir
	//------------------ y se comenta base_url....
	...
	$cfg['root_dir']    =$_SESSION["dirrootsite"];
	$cfg['base_url'] 	=$_SESSION["urlsite"];
	//----------------------------------------------------------------------------
