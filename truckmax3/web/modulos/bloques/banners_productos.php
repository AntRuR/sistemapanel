<?php //á
	...
	$object['grupos']=select(
		array(
		  "id",
		  "nombre"
		  ),'productos_grupos','where visibilidad=1 limit 0,6',0,
		array(
			'header:nombre'=>'{nombre}',
			'header:url'=>array('url'=>array("index.php?modulo=items&tab=productos&acc=list&gru={id}&friendly={nombre}")),
			'items'=>array('filas'=>array('id,nombre','productos_items','where visibilidad=1 and id_grupo={id}',0,
			array(
