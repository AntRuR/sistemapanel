...
/*
$TEMP=fila(array("CONCAT_WS(' ',nombre,direccion) as v"),"productos_ubicaciones","where id=".$LL0['id_ubicacion_llegada'],0);
$LL['id_ubicacion_llegada']=$TEMP['v'];
*/
$TEMP=fila(array("direccion as v"),"productos_ubicaciones","where id=".$LL0['id_ubicacion'],0);
...
$LL['documento']="Factura N° ".dato('venta_factura','productos_items_items',"where id=".$LL0['id_item_item']);

$LL['fecha_salida']=$LL['fecha_entrega'];
...
<tr><td  class="labelwhite">
	...
	<tr><td colspan=2 class="linea" style="height:20px;">&nbsp;</td></tr>
	</table>
...
<tr><td class="valuewhite" colspan=2 >ENTREGA DE UNIDAD</td></tr>
...
//      $html2pdf->setModeDebug();
	...
	$html2pdf->Output('guia_entregas_'.date("Y-m-d_h_m_s").'_codigo_'.$II.'.pdf');
