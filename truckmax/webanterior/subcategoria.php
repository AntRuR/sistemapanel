...
if($_GET['subcate']==16){	
	if(isset($_GET['empezar'])){
		$query4 = "	SELECT producto.*, top30.* FROM producto INNER JOIN top30 ON top30.id_pro=producto.id_pro order by top30.id_top desc limit ".$empezar.",6";
	}else{
		//$query4 = "select a.id_pro,b.*,c.des_cat_es as nombre_categoria,d.des_subcat_es as nombre_subcategoria from top30 as a, producto as b,categoria c,subcategoria d where a.id_pro=b.id_pro and b.id_cat=c.id_cat and b.id_subcat=d.id_subcat order by a.id_top desc limit 0,6";
		$query4 = "	SELECT producto.*, top30.* FROM producto INNER JOIN top30 ON top30.id_pro=producto.id_pro order by top30.id_top desc limit 0,6";
	}
}else{
	if(isset($_GET['empezar'])){
		$query4 = "select a.*,b.des_cat_es as nombre_categoria,c.des_subcat_es as nombre_subcategoria from producto a,categoria b,subcategoria c where a.id_subcat='".$_GET['subcate']."' and a.id_cat=b.id_cat and a.id_subcat=c.id_subcat order by a.id_pro limit ".$empezar.",6";
	}else{
		$query4 = "select a.*,b.des_cat_es as nombre_categoria,c.des_subcat_es as nombre_subcategoria from producto a,categoria b,subcategoria c where a.id_subcat='".$_GET['subcate']."' and a.id_cat=b.id_cat and a.id_subcat=c.id_subcat order by a.id_pro limit 0,6";
	}
}
...
if($_GET['subcate']==16){
	...
	$query5 = "select count(*) as cantidad from producto where id_subcat = '".$_GET['subcate']."'";
}
                ...
                <table width="728" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <table width="700" border="0" cellpadding="0" cellspacing="0" style="width:100%">
                      <tr>
                        <td height="28" class="ruta"><? 
						if($_GET['subcate']==16){ 
						echo ' NOVEDADES -Ultimas versiones de software y equipos ';
						}else{
                          ...
                          <tr>
                            ...
                            <td height="60" align="center" valign="top" background="images/div_sub_degrade.jpg" style="background-image:url(images/div_sub_degrade.jpg); background-repeat:repeat-x;">
                              ...
                              <? //consulta para identificar el comentario de subcategoria
							   ...
							   ?>
                                <td class="texto"><? echo $row_rs_query22["coment_sc"] ?></td>
                              </tr>
                            </table>
                            </td>
                            <td width="1" valign="top" background="images/div_sub.jpg"></td>
