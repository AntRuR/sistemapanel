...
$row_rs_query2 = mysql_fetch_assoc($rs_query2);
	...
	if(isset($_GET['empezar'])){
		$query4 = "SELECT * FROM `producto` WHERE `novedad`<>'' ORDER BY `producto`.`id_pro` DESC limit ".$empezar.",6";
	}else{
		$query4 = "SELECT * FROM `producto` WHERE `novedad`<>'' ORDER BY `producto`.`id_pro` DESC limit 0,6";
	}
                ...
                <table width="728" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <table width="700" border="0" cellpadding="0" cellspacing="0" style="width:100%">
                      <tr>
                        <td height="28" class="ruta">NOVEDADES                  </td>
                        </tr>
                      <tr>
                        <td height="28">
                              ...
                              <? //consulta para identificar el comentario de subcategoria
							   ...
							   ?>
                                <td class="texto"><p>
                                  ...
                                  PRESENTAMOS las NOVEDADES de nuestra p&aacute;gina Web <a href="http://www.truckmax.com.pe">www.truckmax.com.pe</a> . Veh&iacute;culos reci&eacute;n importados de gran calidad y eficiencia, en stock y en exhibici&oacute;n en nuestros locales. </p>
                                  </td>
                              </tr>
                            </table>
                            </td>
