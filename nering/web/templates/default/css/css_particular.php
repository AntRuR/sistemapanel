...
.id_banner_main div.foto {
position:relative;
}
.id_banner_main div.foto div:before {
position:absolute;
width:158px; height:181px;
content:url("../img/particular/banner/bg.jpg");
z-index:1000;
right:25px;
bottom:73px;
}
.banner_main-listados .listado_item .texto {
    background: none repeat scroll 0 0 #5EB6E6;
    bottom: -3px;
...
/*publicidad_fotos*/
<?php css_render_esquinas('id_publicidad_fotos','bloques/publicidad_fotos',array('buts'=>array(-230,10))); ?>

/*proyectos_realizados*/
<?php css_render_esquinas('id_proyectos_realizados','bloques/publicidad_fotos',array('buts'=>array(-235,10))); ?>
...
/*recomendar*/
.id_recomendar #recomendar_submit { background-color:#0B4992; color:#FFF; border:0; font-size:14px;  }
...
/*productos_file*/
<?php css_render_esquinas('id_productos_file','bloques/productos_file',array('buts'=>array(-235,10))); ?>
