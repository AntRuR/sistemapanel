...
array(
	'header'=>$Block['header'],	
	array(
	 752=>"bloques/banner_main.php",//L[x]V[x]	//panel:banners_fotos,banners_fotos_fotos; medidas:(3:484x174)
	 210=>"bloques/banner_servicios.php",
	 ),	
	"bloques/print_marquesina.php",//L[x]V[]			//blog_noticias,blog_actividades,blog_fotos,blog_fotos_fotos,blog_videos,blog_videos_videos	
	array(
		$Block['bar_izquierda'],//
		array_merge(
			array(
