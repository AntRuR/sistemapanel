...
function render_foreig_subs($obj0,$id,$urd){
	...
	foreach($obj0 as $obj2){
		foreach($obj2 as $obj){
			...
			echo "title='".sizeof($lineas)." ".$objeto_tabla[$obj['obj']]['nombre_plural']."' href='".$reemplazo."'>".sizeof($lineas)." ".$pluralIma."</a>";
			echo '</div>';
...
function pre_procesar_objeto_tabla_0($me){
	...
	if($me['user']=='1'){
		if(
			...
			$extra_filtro.=" and ".$me['tabla'].".user='".$_SESSION['usuario_id']."' ";
			}
		}
	}
