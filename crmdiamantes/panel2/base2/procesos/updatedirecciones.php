...
// 	"clientes",
// 	"where 1 
// 	and fecha_creacion > '2014-01-01 00:00:00' 
// 	and distrito!=''
// 	and direccion!=''
// 	"
// 		)
...
if(0)
$ventas_items=select(
	array('id','direccion','departamento','distrito'),
	"clientes",
	"where 1 
	and fecha_creacion > '2014-01-01 00:00:00' 
	and distrito!=''
	...
	0,
	array(
	'distrito'=>array('dato'=>array('nombre','geo_distritos','where id={distrito}')),
	'departamento'=>array('dato'=>array('nombre','geo_departamentos','where id={departamento}')),
	)
	);

if(0)
foreach($ventas_items as $item){
	// if($item['distrito']!='' and $item['direccion']!=''){
		update(
			array(
			'direccion'=>$item['direccion']." - ".$item['departamento']." ".$item['distrito']
			),
			'clientes',
			'where id='.$item['id'],
			0
