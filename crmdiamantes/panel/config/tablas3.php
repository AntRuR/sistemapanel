...
$objeto_tabla['VENTAS_MENSAJES']=array(
		...
		'postscript'	=> '
			...
			if(SS=="insert" and LL["cumplir_alertas"]=="1")
			{
				...
				$pendientes=contar("ventas_mensajes","where id!=".LL["id"]." and estado in (3) and id_grupo=".LL["id_grupo"]." ",0);
				...
				if($pendientes>0){
					...
					update(
						...
						"ventas_mensajes",
						"where id!=".LL["id"]." and id_grupo=".LL["id_grupo"]." and estado=3 ");
		...
		<a href="custom/ventas_mensajes.php?conf=editar%3D0%26alerta_fecha%7Cqueries%3D1%26fecha_creacion%7Cqueries%3D0%26fecha_creacion%7Clistable%3D0%26nombre_plural%3DAlertas%26titulo%3DAlertas%26crear%3D0%26edit%3D0%26order_by%3Did+desc'.
