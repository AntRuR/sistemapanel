...
<div id="div_bloque_recomendados" class="div_bloque" >
	
    <div class="titulo">
    	<!--lados-->
		<span class='titulo_izq'></span>
		<span class='titulo_der'></span>    
    	<h3><?php echo $NOOB['titulo'];?></h3>    
	</div>
    ...
    <div class="bloque_pie div_barra">
    	...
    	<?php /*<span class="total" style="float:left;"><?php echo sizeof($NOOB['items']);?> recomendados</span>*/?>
