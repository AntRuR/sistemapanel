...
MooEditable.Actions = new Hash({
	...
	createlink: {
		...
		dialogs: {
			alert: MooEditable.UI.AlertDialog.pass('Por favor seleccionar el texto al que agregará el Enlace.'),
			prompt: function(editor){
				return MooEditable.UI.PromptDialog('Ingresar una dirección', 'http://', function(url){
