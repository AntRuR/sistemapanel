          ...
          <tr>
            ...
            ?>
                <tr>
                  ...
                  <td><?php echo $row_rs_query0['equivalencia']?></td>
                  <td><a href="modificacion-marcadorequivalencia3.php?idNew=<?php echo $row_nNews['id_marcador']; ?>" target="_blank" class="login">edit</a></td>
                </tr>
