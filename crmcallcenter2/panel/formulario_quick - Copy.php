...
//prin($_GET);
echo '<style>
		#div_allcontent {min-width:0;} .legend{padding:0;margin:0;} .contenido_principal {background:none !important;box-shadow:none;} body {background:url("http://springpadit.com/springpad/images/layout/bg.texture.main.png") repeat scroll left top #F5EEE6 !important;} .contenido_principal{border-radius:0;} .formulario {border:0;} .formulario label {padding-top:0px;padding-bottom:0px;padding-left:5px;} .formulario .form_input {margin-top:0px;margin-bottom:0px;}.boton_right{display:none;}
		</style>';
